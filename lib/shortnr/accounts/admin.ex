defmodule Shortnr.Accounts.Admin do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Shortnr.Repo)
  ...
  """
  def valid_password?(%Shortnr.Accounts.Admin{hashed_password: hashed_password}, password)
